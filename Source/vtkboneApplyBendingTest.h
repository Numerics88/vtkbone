...
public:
  ...
  //@{
  /*! Specifies the x,y coordinates of the Neutral Axis origin. Default is
      0,0 . */
  ...
  //@{
  /*! Specifies the angle of the Neutral Axis origin.  0 is along the x
      axis. Units are radians.	Default is pi/2 (i.e. along the y axis). */
  vtkSetMacro(NeutralAxisAngle, double);
  vtkGetMacro(NeutralAxisAngle, double);
  //@}

  //@{
  /*! Specifies the bending angle.  The Top and Bottom surfaces are each
      tilted by half this amount.  Units are radians.  Default is 0.01745,
      corresponding to 1º. */
