...
// .NAME vtkboneConstraint - a constraint for a finite element mesh
// .SECTION Description
...
public:
  ...
  // this operation is fairly slow.  Also removes corresponding entries
  // from associated fields (e.g. Scalars and/or Vectors).
  ...
  // Description:
  // This method checks to see if the attributes
  // match the geometry.  Many filters will crash if the number of
  // tuples in an array is less than the number of points.
  ...
  // WARNING: Using ShallowCopy will result in both this and the original object
  //          trying to manage the underlying data.  I recommend that you either
  //          regard both as constants, or that you delete the original object
  //          after this call.
