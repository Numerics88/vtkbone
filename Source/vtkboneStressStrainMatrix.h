...
/*! @class   vtkboneStressStrainMatrix
    @brief   Some calculation functions for stress-strain matrices.
...
public:
  ...
  //@{
  /*! Set the stress-strain matrix using the 21 upper triangular packed
      values. */
  ...
  //@{
  /*! Get the 21 upper triangular packed values of the stress-strain
      matrix. */
