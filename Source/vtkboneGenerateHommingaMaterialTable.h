...
/*! @class   vtkboneGenerateHommingaMaterialTable
    @brief   generates a
...
public:
  ...
  //@{
  /*! Set/Get the material ID equal for the first material definition in
      the sequence. Default 1. */
  ...
  //@{
  /*! Set/Get the material ID equal for the first material definition in
      the sequence. Note that the material table has in fact only one
      entry, which is a material array at material ID FirstIndex. Default
      127. */
  ...
  /*! Set the material that is to represent "Full Scale" or maximum
      ...
      intended to be only a base class. The default is an instance of
      vtkboneLinearIsotropicMaterial constructed with its default
      parameters. */
